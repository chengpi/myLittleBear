var timer = null,
    index = 0,
    pics = byId("home-sec-div").getElementsByTagName("img"),
    dots = byId("dots").getElementsByTagName("span"),
    titles = byId("home-sec-div").getElementsByTagName("h3");
    size = pics.length,
    prev = byId("prev"),
    next = byId("next");
...
function changeImg(){
    for(var i=0,len=dots.length;i<len;i++){
        ...
        // document.getElementById("home-sec-title").innerHTML = "2020短视频变现的重要渠道";
...
function slideImg(){
    startAutoPlay();
    var home = byId("home");
    var banner = byId("home-sec-div");
    // var menuContent = byId("menu-content");

    addHandler(home,"mouseover",stopAutoPlay);
    addHandler(home,"mouseout",startAutoPlay);
